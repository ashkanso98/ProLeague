...
namespace ProLeague.Application.Services
{
    public class NewsService : INewsService
    {
        ...
        public async Task<NewsIndexViewModel> GetNewsIndexViewModelAsync(int? leagueId, int? teamId, int pageIndex)
        {
            int pageSize = 25; // Show 25 news articles per page
            var paginatedNews = await _unitOfWork.News.GetPaginatedFilteredNewsAsync(leagueId, teamId, pageIndex, pageSize);
            ...
            var viewModel = new NewsIndexViewModel
            {
                ...
                Leagues = new SelectList(leagues, "Id", "Name", leagueId),
                Teams = new SelectList(teams, "Id", "Name", teamId),
